...
See [`findings.html`](findings.html) FOF section. Supporting evidence in [`evidence/`](evidence/) (6 documents — see the [full index](../../../index.md#google-platform-worker-misclassification)).
