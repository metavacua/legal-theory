...
- **[Matters](#matters)** — 5 active court-record matters, each with a complaint-structure
  README, a findings-of-fact stub, and an evidentiary research corpus.
- **[Theory](#theory)** — jurisdictional legal-authority research, organized by level
  (federal constitutional → federal statutes → California statutes).

---

## Matters

Each matter contains a complaint-structure `README.md`, a `findings.md`
(FRCP Rule 52 findings-of-fact/conclusions-of-law stub), and an `evidence/` corpus.

### [Google Platform Worker Misclassification](court-record/matters/google-platform-misclassification/README.md)
...
constitutional questions that belong to higher levels. Only branches with content are listed;
`federal-constitutional/reversal-arguments`, `federal-constitutional/specializations`,
`federal-statutes/reversal-arguments`, `federal-statutes/specializations`,
`california-statutes/reversal-arguments`, all of `california-constitutional/*`, and all of
`municipal/*` are scaffolded in the taxonomy but not yet populated.
...
Only the two branches with filed content are listed; the rest of the legislative/executive
taxonomy (federal Congress, CA county/city, presidential orders, CA governor, and most federal
and state agencies) is scaffolded but empty.
...
- **[Language Models Are Databases: A Technical and Legal Position Paper](papers/ai_and_ip/llm-database-theory/README.md)**
  ...
  [primary article](papers/ai_and_ip/llm-database-theory/src/01-llm-database-theory.html) ·
  [legal corpus connections](papers/ai_and_ip/llm-database-theory/src/02-legal-corpus-connections.html)
...
- **[Consolidated References & Bibliography](bibliography/references.html)** — every citation
  ...
  by `docs/scripts/build_bibliography.py`; see the
  [design spec](superpowers/specs/2026-07-23-consolidated-bibliography-design.md) and
  [implementation plan](superpowers/plans/2026-07-23-consolidated-bibliography-plan.md). An
  Appendix section logs entries that couldn't be automatically classified, each with its source
  file, for manual follow-up.

---

*This index is regenerated by hand; see
[the reorganization plan](superpowers/plans/2026-07-20-repo-accessibility-reorganization.md)
for the audit this structure is based on and what's still pending.*
