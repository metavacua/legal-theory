...
bibliography.bib. See git history for the original design rationale
(the planning docs under docs/superpowers/ were retired from the
tracked tree; git log still has them)."""
